...
-   If you want a different parameter list from the base class version, you cannot override it. Consider overloading it instead. For more information, see [Procedure Overloading](../../visual-basic/language-reference/procedures/procedure-overloading.md).  
