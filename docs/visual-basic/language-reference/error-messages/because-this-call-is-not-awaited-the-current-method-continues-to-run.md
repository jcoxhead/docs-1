...
3.  Replace the code in the **XAML** view of MainWindow.xaml with the following code.  
    ...
    ```  
     ...
     For more information about the XAML Designer, see [Creating a UI by using XAML Designer](../Topic/Creating%20a%20UI%20by%20using%20XAML%20Designer%20in%20Visual%20Studio.md). For information about how to build your own simple UI, see the "To create a WPF application" and "To design a simple WPF MainWindow" sections of [Walkthrough: Accessing the Web by Using Async and Await](../Topic/Walkthrough:%20Accessing%20the%20Web%20by%20Using%20Async%20and%20Await%20(C%23%20and%20Visual%20Basic).md).  
