...
## Remarks  
 The `My.Resources` object provides access to the application's resources and lets you dynamically retrieve resources for your application. For more information, see [Managing Application Resources (.NET)](../Topic/Managing%20Application%20Resources%20\(.NET\).md).  
...
## See Also  
 ...
 [Managing Application Resources (.NET)](../Topic/Managing%20Application%20Resources%20\(.NET\).md)   
