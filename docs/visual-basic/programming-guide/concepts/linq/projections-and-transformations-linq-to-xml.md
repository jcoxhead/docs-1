---
title: "Projections and Transformations (LINQ to XML) (Visual Basic) | Microsoft Docs"
ms.custom: ""
ms.date: "2015-07-20"
...
|[How to: Generate XML from CSV Files (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-generate-xml-from-csv-files.md)|Shows how to use [!INCLUDE[vbteclinq](../../../../csharp/getting-started/includes/vbteclinq_md.md)] to parse a CSV file and generate XML from it.|  
