---
title: "LINQ to XML vs. Other XML Technologies2 | Microsoft Docs"
ms.custom: ""
ms.date: "2015-07-20"
...
## LINQ to XML vs. XmlLite  
 ...
 XmlLite is not integrated with [!INCLUDE[vbteclinqext](../../../../csharp/getting-started/includes/vbteclinqext_md.md)]. It does not yield the programmer productivity improvements that are the motivating force behind [!INCLUDE[vbteclinq](../../../../csharp/getting-started/includes/vbteclinq_md.md)].  
