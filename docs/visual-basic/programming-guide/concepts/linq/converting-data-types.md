...
|Cast|Casts the elements of a collection to a specified type.|`From … As …`|<xref:System.Linq.Enumerable.Cast*?displayProperty=fullName><br /><br /> <xref:System.Linq.Queryable.Cast*?displayProperty=fullName>|  
