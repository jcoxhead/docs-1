...
1.  Create a new Class Library project and name it "LoanClass". For more information, see [Creating Solutions and Projects](../Topic/Creating%20Solutions%20and%20Projects.md).  
