...
|[Creating XML Trees in C# (LINQ to XML)](../../../../csharp/programming-guide/concepts/linq/creating-xml-trees-in-csharp-linq-to-xml-2.md)|Shows how to create trees in C#.|  
