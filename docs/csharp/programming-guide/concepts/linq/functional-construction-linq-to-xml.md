---
title: "Functional Construction (LINQ to XML) (C#) | Microsoft Docs"
ms.custom: ""
ms.date: "2015-07-20"
...
```  
 ...
 These features also enable you to write code that uses the results of [!INCLUDE[vbteclinq](../../../../csharp/getting-started/includes/vbteclinq_md.md)] queries when you create an XML tree, as follows:  
