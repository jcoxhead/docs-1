...
|[How to: Generate XML from CSV Files (C#)](../../../../csharp/programming-guide/concepts/linq/how-to-generate-xml-from-csv-files.md)|Shows how to use [!INCLUDE[vbteclinq](../../../../csharp/getting-started/includes/vbteclinq_md.md)] to parse a CSV file and generate XML from it.|  
