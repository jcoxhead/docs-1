...
|[Scope of Default Namespaces in C#](../../../../csharp/programming-guide/concepts/linq/scope-of-default-namespaces-in-csharp1.md)|Demonstrates the appropriate way to write queries for XML in the default namespace.|  
