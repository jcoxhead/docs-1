...
A left outer join is a join in which each element of the first collection is returned, regardless of whether it has any correlated elements in the second collection. You can use [!INCLUDE[vbteclinq](../../../csharp/getting-started/includes/vbteclinq_md.md)] to perform a left outer join by calling the <xref:System.Linq.Enumerable.DefaultIfEmpty*> method on the results of a group join.  
