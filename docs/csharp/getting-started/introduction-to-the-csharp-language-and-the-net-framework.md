...
-   For more information about [!INCLUDE[vbteclinq](../../csharp/getting-started/includes/vbteclinq_md.md)], see [LINQ (Language-Integrated Query)](../Topic/LINQ%20\(Language-Integrated%20Query\).md).  
